...
(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		genTable: function(thisdate) {
			...
			html += '<img class = "remove" src = "css/img/remove-' + this.options.style + '.png"><img class = "nexti" src = "css/img/next-' + this.options.style + '.png">';
			html += '<img class = "geti" src = "css/img/get-' + this.options.style + '.png"><img class = "previ" src = "css/img/prev-' + this.options.style + '.png"><thead><tr>';
			var w = true;
			while(sd < ed) {
				html += '<tr>'
				if(w == true) {
